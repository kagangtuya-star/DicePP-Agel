...
CFG_GROUP_JOIN_AUTO_AGREE = "group_join_auto_agree"
DEFAULT_CONFIG[CFG_GROUP_JOIN_AUTO_AGREE] = "0"
DEFAULT_CONFIG_COMMENT[CFG_GROUP_JOIN_AUTO_AGREE] = "骰娘为管理员，有其他人加群时是否自动同意, 0为无视（其他人来处理）, 1为自动同意"
